...
if "install" in sys.argv:
    ...
    for lib_path in lib_paths:
        existing_path = os.path.abspath(os.path.join(lib_path, "libgraph"))
...
# Any packages inside the libgraph source folder we dont want in the packages
EXCLUDE_FROM_PACKAGES = [ ]

# Dynamically calculate the version based on courier.VERSION.
version = __import__('libgraph').get_version()
...
setup(name="libgraph",
      ...
      url="https://github.com/panyam/libgraph",
      package_data = {
          'libgraph': [
